    ...
    <div className="w-full max-w-2xl">
      ...
      >
        <CardHeader className="text-center space-y-2">
          ...
          >
            Vincent Algorithmic Stablecoin Liquidation
          </CardTitle>
          <CardDescription
          ...
          >
            Automate Undercolaterized Position Liquidations
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-5">
          ...
          >
            Secure and verifiable Liquidation automation for you on Base.
          </p>
          ...
          >
            This application allows you to automate liquidation operations on
            undercollateralized users of the Vincent Algorithmic Stablecoin.
          </p>
